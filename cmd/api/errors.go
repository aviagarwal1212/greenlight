...
// The notFoundResponse method will be used to send a 404 Status Not Found status code
// and JSON response.
...
// status code and JSON response. It includes the validation errors in the response.
